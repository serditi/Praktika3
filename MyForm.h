...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Ïîêàçàòü òàáëèöó è ýêñòðåìóìû ôóíêöèè";
			...
			this->label1->Text = L"Ââåäèòå çíà÷åíèå XN";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Ââåäèòå çíà÷åíèå XK";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Ââåäèòå çíà÷åíèå XH";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Ââåäèòå çíà÷åíèå a";
			// 
			// pictureBox1
			// 
			...
			this->label5->Text = L"Òàáëèöà çíà÷åíèé ôóíêöèè";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Ìàêñèì.çíà÷.ôóíêöèè";
			// 
			// label7
			// 
			...
			this->label7->Text = L"Ìèíèì.çíà÷.ôóíêöèè";
			// 
			// textBox5
			// 
			...
			this->label8->Text = L"åñëè x<=0";
			// 
			// label9
			// 
			this->label9->AutoSize = true;
			this->label9->Location = System::Drawing::Point(334, 126);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(76, 16);
			this->label9->TabIndex = 18;
			this->label9->Text = L"åñëè 0<x<a";
			// 
			// label10
			// 
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			(textBox3->Text != "") && (textBox4->Text != ""))
		{
			...
			MessageBox::Show("Çàïîëíèòå, ïîæàëóéñòà, äàííûå","Îøèáêà ââîäà äàííûõ",
